        ...
        <a href="https://smartx-form.ramand.my.id/" target="blank">
            <div class="flex mt-10 items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 h-80">
                <div>
                    ...
                    <h2 class="mb-2 mt-3 text-lg font-bold text-gray-600 dark:text-gray-400">
                        SMART CITY
                    </h2>
        ...
        <a href="https://smart-building.ptmsp.id/login">
            <div
                ...
                <div>
                    ...
                    <p
                        class="mt-2 text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
